...
#define COMM_RESEND_TICK(resends)   2
...
typedef unsigned long long comm_time;
...
#define COMM_DBG 0
#if COMM_DBG
#define COMM_PHY_DBG(x, ...)   printf("COMM_PHY:"x"\n", ##__VA_ARGS__)
#define COMM_LNK_DBG(x, ...)   printf("COMM_LNK:"x"\n", ##__VA_ARGS__)
#define COMM_NWK_DBG(x, ...)   printf("COMM_NWK:"x"\n", ##__VA_ARGS__)
#define COMM_TRA_DBG(x, ...)   printf("COMM_TRA:"x"\n", ##__VA_ARGS__)
#else
